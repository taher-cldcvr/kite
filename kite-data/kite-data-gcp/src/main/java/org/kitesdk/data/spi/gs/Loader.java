...
package org.kitesdk.data.spi.gs;
...
public class Loader implements Loadable {
  ...
  private static class URIBuilder implements OptionBuilder<DatasetRepository> {
    ...
    public DatasetRepository getFromOptions(Map<String, String> match) {
      LOG.info("getFromOptions with map {}",match);
  ...
  public void load() {
    ...
    Registration.register(
        ...
        builder);
    LOG.info("URI Pattern {} is registered",new URIPattern("gs:/*path"));
    LOG.info("URI Pattern {} is registered",new URIPattern("gs:/*path/:namespace/:dataset"));
  }
